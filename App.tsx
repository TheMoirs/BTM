...
// ── Clerk configuration ───────────────────────────────────────────────────
// Using a pk_test_ (development instance) key: Clerk resolves its own
// Frontend API from the key itself (a *.clerk.accounts.dev host) and works
// on any domain with no custom DNS or proxy setup needed. The previous
// host-based resolution here was for a pk_live_ production custom-domain
// setup (e.g. clerk.yourdomain.com via CNAME) — revisit if/when this app
// moves to a pk_live_ key on a real custom domain.
